...
const footerLinks = {
  ...
  programs: [
    { label: "MERN Stack Internship", href: "/internships/mern-stack-chennai" },
    { label: "Python Internship", href: "/internships/python-chennai" },
    { label: "Java Full Stack Internship", href: "/internships/java-chennai" },
    { label: "AI & ML Internship", href: "/internships/ai-ml-chennai" },
  ...
  support: [
    ...
    { label: "Terms & Conditions", href: "/terms" }, // Razorpay prefers this exact naming
    { label: "Refund Policy", href: "/refund" },
    { label: "Contact Us", href: "/contact" }, // Essential for KYC
  ],
};
              ...
              <ul className="space-y-4">
                {footerLinks.company.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-zinc-500 dark:text-zinc-400 hover:text-orange-500 transition-colors flex items-center group font-medium"
                    >
              ...
              <ul className="space-y-4">
                {footerLinks.programs.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-zinc-500 dark:text-zinc-400 hover:text-orange-500 transition-colors font-medium"
                    >
                      {link.label}
                    </Link>
                  </li>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div className="text-zinc-500 dark:text-zinc-400 text-sm font-medium flex flex-col space-y-1">
                  <a
                    href="tel:+919840234475"
                    className="hover:text-orange-500 transition-colors"
                  >
                    +91 98402 34475
                  </a>
                  <a
                    href="tel:+919884468682"
                    className="hover:text-orange-500 transition-colors"
                  >
                    +91 98844 68682
                  </a>
              ...
              <div className="flex gap-4">
                ...
                <a
                  href="mailto:info@inetztech.com"
                  className="text-zinc-500 dark:text-zinc-400 text-sm font-medium hover:text-orange-500 transition-colors"
                >
                  info@inetztech.com
                </a>
              </div>
